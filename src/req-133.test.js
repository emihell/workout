...
describe('own-* entries carry the legacy fields', () => {
  it('equipment, category, instructions, and muscles today\'s readers accept', () => {
    ...
    // req-145 (sanctioned count pin) — + the 8 batch-2 adds. req-147 (DEC-074 §1): + the 5 batch-3 adds; req-148: + 8 batch-4 adds; req-151: + 8 batch-5 adds.
    assert.equal(OWN_EXERCISES.length, 66)
