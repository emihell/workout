...
const ROWS = [
  ...
  ['Reverse_Grip_Bent-Over_Rows', 'horizontal-pull', 'barbell', 'lats rhomboids', 'biceps rear-delt lower-back', 'weight-reps', 'fam-row', ['Underhand Barbell Row', 'Supinated Barbell Row', 'Yates Row']],
