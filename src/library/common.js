...
const ROWS = [
  ...
  // Legs
  ['Barbell_Squat', 'squat', 'barbell', 'quads glute-max', 'adductors hamstrings lower-back', 'weight-reps', 'fam-squat', ['Squat', 'Squats', 'Barbell Back Squat', 'BB Squat']],
  ...
  ['Dumbbell_Bicep_Curl', 'curl', 'dumbbell', 'biceps', 'brachialis forearms', 'weight-reps', 'fam-curl', ['Bicep Curl', 'Biceps Curl', 'Bicep Curls', 'Dumbbell Curls', 'DB Curl', 'Dumbbell Biceps Curl']],
  ...
  ['Hammer_Curls', 'curl', 'dumbbell', 'brachialis biceps', 'forearms', 'weight-reps', 'fam-hammer-curl', ['Dumbbell Hammer Curl', 'DB Hammer Curl']],
  ...
  ['Stairmaster', 'cardio', 'cardio-machine', 'quads glute-max', 'hamstrings calves', 'cardio', 'fam-stairmaster', ['Stairs', 'Stair Machine', 'Stair Stepper']],
  ...
  ['Decline_Crunch', 'core-flexion', 'bench bodyweight', 'abs', '', 'bodyweight-reps', 'fam-crunch', ['Decline Bench Crunch', 'Decline Sit-Up']],
  ...
  ['Muscle_Up', 'vertical-pull', 'pull-up-bar suspension bodyweight', 'lats triceps', 'biceps rhomboids deltoids abs', 'bodyweight-reps', 'fam-pull-up', ['Muscle Ups', 'Bar Muscle-Up', 'Ring Muscle-Up']],
  ...
  ['own-pistol-squat', 'squat', 'bodyweight', 'quads glute-max', 'adductors hamstrings abs', 'bodyweight-reps', 'fam-own-pistol-squat', ['Pistol', 'Single-Leg Squat', 'One-Leg Squat'], true],
...
export const NOT_STAPLES = [
  ...
  'Plie_Dumbbell_Squat', 'Freehand_Jump_Squat', 'Superman', 'Flutter_Kicks', 'Muscle_Up', 'Handstand_Push-Ups', 'Hanging_Pike',
...
export const DIFFICULTY_LISTS = {
  beginner: [
    ...
    'Single_Leg_Glute_Bridge', 'One-Legged_Cable_Kickback', 'Glute_Kickback', 'Pull_Through', 'Thigh_Abductor',
  ...
  intermediate: [
    'Barbell_Bench_Press_-_Medium_Grip', 'Decline_Barbell_Bench_Press', 'Close-Grip_Barbell_Bench_Press',
    'Barbell_Incline_Bench_Press_-_Medium_Grip', 'Push-Ups_-_Close_Triceps_Position', 'Dips_-_Chest_Version',
    ...
    'Split_Squat_with_Dumbbells', 'own-cossack-squat', 'Glute_Ham_Raise', 'Barbell_Hip_Thrust', 'own-copenhagen-plank',
  ...
  advanced: [
    'Power_Clean', 'Clean_and_Jerk', 'Snatch', 'Hang_Clean', 'Clean', 'Overhead_Squat', 'Natural_Glute_Ham_Raise',
