...
const ROWS = [
  ...
  ['Cable_Crossover', 'fly', 'cable', 'pecs', 'front-delt', 'weight-reps', 'fam-fly', ['Cable Flye', 'Cable Chest Fly', 'Cable Crossovers', 'High-to-Low Cable Fly']],
  ...
  ['Dumbbell_Shoulder_Press', 'vertical-push', 'dumbbell bench', 'front-delt', 'side-delt triceps', 'weight-reps', 'fam-overhead-press', ['Overhead DB Press', 'DB Shoulder Press', 'Dumbbell Overhead Press', 'Seated DB Shoulder Press', 'Seated Dumbbell Shoulder Press', 'Seated Dumbbell Press', 'Standing Dumbbell Press']],
  ['Arnold_Dumbbell_Press', 'vertical-push', 'dumbbell bench', 'front-delt', 'side-delt triceps', 'weight-reps', 'fam-overhead-press', ['DB Arnold Press']],
  ['Machine_Shoulder_Military_Press', 'vertical-push', 'machine', 'front-delt', 'side-delt triceps', 'weight-reps', 'fam-overhead-press', ['Shoulder Press Machine', 'Seated Shoulder Press Machine']],
  ['Push_Press', 'vertical-push', 'barbell', 'front-delt', 'side-delt triceps quads glute-max', 'weight-reps', 'fam-overhead-press', ['Barbell Push Press']],
  ['own-landmine-press', 'vertical-push', 'barbell landmine', 'front-delt', 'upper-chest triceps', 'weight-reps', 'fam-overhead-press', ['Landmine Shoulder Press', 'Half-Kneeling Landmine Press', 'Landmine Presses']],
  ['own-z-press', 'vertical-push', 'barbell', 'front-delt', 'side-delt triceps abs', 'weight-reps', 'fam-overhead-press', ['Barbell Z Press', 'Seated Barbell Z Press']],
  ...
  ['Weighted_Pull_Ups', 'vertical-pull', 'pull-up-bar plate', 'lats', 'biceps rhomboids', 'weight-reps', 'fam-pull-up', ['Weighted Pull-Ups']],
  ...
  ['Suspended_Row', 'horizontal-pull', 'suspension bodyweight', 'rhomboids lats', 'rear-delt biceps', 'bodyweight-reps', 'fam-inverted-row', ['TRX Row', 'Ring Row', 'Suspended Row']],
  ...
  ['Rack_Pulls', 'hinge', 'barbell', 'lower-back glute-max', 'hamstrings traps forearms', 'weight-reps', 'fam-deadlift', ['Rack Pulls', 'Block Pull']],
  ...
  ['own-single-leg-rdl', 'hinge', 'dumbbell', 'hamstrings glute-max', 'lower-back glute-med', 'weight-reps', 'fam-romanian-deadlift', ['Single-Leg RDL', 'SL RDL', 'Single-Leg Dumbbell RDL', 'One-Leg Romanian Deadlift', 'Single-Leg Deadlift'], true],
  ...
  ['Pull_Through', 'hinge', 'cable', 'glute-max hamstrings', 'lower-back', 'weight-reps', 'fam-pull-through', ['Pull-Through', 'Rope Pull-Through', 'Glute Pull-Through']],
  ...
  ['Crunches', 'core-flexion', 'bodyweight', 'abs', '', 'bodyweight-reps', 'fam-crunch', ['Floor Crunch']],
  ...
  ['Mountain_Climbers', 'core-stability', 'bodyweight', 'abs hip-flexors', 'quads front-delt', 'time', 'fam-mountain-climbers', ['Mountain Climbers']],
  ...
  ['Smith_Machine_Overhead_Shoulder_Press', 'vertical-push', 'smith-machine bench', 'front-delt', 'side-delt triceps', 'weight-reps', 'fam-overhead-press', ['Smith Shoulder Press', 'Smith Overhead Press']],
  ...
  ['Seated_Barbell_Military_Press', 'vertical-push', 'barbell bench', 'front-delt', 'side-delt triceps', 'weight-reps', 'fam-overhead-press', ['Seated Military Press', 'Seated Barbell Shoulder Press', 'Seated OHP']],
  ...
  ['Handstand_Push-Ups', 'vertical-push', 'bodyweight', 'front-delt', 'side-delt triceps upper-chest', 'bodyweight-reps', 'fam-handstand-push-up', ['HSPU', 'Wall Handstand Push-Up']],
  ...
  ['own-pike-push-up', 'vertical-push', 'bodyweight', 'front-delt', 'side-delt triceps upper-chest', 'bodyweight-reps', 'fam-handstand-push-up', ['Pike Push-Ups', 'Pike Press']],
  ...
  ['Leverage_High_Row', 'vertical-pull', 'machine', 'lats rhomboids', 'rear-delt biceps', 'weight-reps', 'fam-row', ['High Row Machine', 'Plate-Loaded High Row']],
  ...
  ['Oblique_Crunches', 'core-flexion', 'bodyweight', 'obliques', 'abs', 'bodyweight-reps', 'fam-crunch', ['Oblique Crunches'], true],
  ...
  ['Shoulder_Press_-_With_Bands', 'vertical-push', 'bands', 'front-delt', 'side-delt triceps', 'bodyweight-reps', 'fam-overhead-press', ['Banded Shoulder Press', 'Resistance Band Shoulder Press', 'Band Overhead Press']],
  ...
  ['Svend_Press', 'horizontal-push', 'plate', 'pecs', 'front-delt triceps', 'weight-reps', 'fam-svend-press', ['Plate Squeeze Press']],
  ...
  ['Two-Arm_Kettlebell_Military_Press', 'vertical-push', 'kettlebell', 'front-delt', 'side-delt triceps', 'weight-reps', 'fam-overhead-press', ['Double Kettlebell Overhead Press', 'Double KB Press']],
  ...
  ['One-Arm_Kettlebell_Military_Press_To_The_Side', 'vertical-push', 'kettlebell', 'front-delt', 'side-delt triceps abs', 'weight-reps', 'fam-overhead-press', ['Single-Arm Kettlebell Press', 'KB Press', 'Kettlebell Overhead Press'], true],
  ...
  ['Zercher_Squats', 'squat', 'barbell', 'quads glute-max', 'abs rhomboids adductors', 'weight-reps', 'fam-squat', ['Zercher Squats', 'Barbell Zercher Squat']],
  ...
  ['own-spoto-press', 'horizontal-push', 'barbell bench', 'pecs', 'triceps front-delt', 'weight-reps', 'fam-bench-press', ['Spoto Bench Press']],
]
...
export const DISPLAY_NAMES = {
  ...
  Ring_Dips: 'Ring Dip',
  Suspended_Row: 'Suspension Row', // req-141
}
...
export const NOT_STAPLES = [
  ...
  // req-141 (planning's coach call, DEC-067): gym-dependent or niche accessory lifts
  'own-copenhagen-plank', 'own-bayesian-curl', 'own-pendulum-squat', 'own-belt-squat', 'own-z-press', 'own-meadows-row',
]
