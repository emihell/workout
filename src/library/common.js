...
const ROWS = [
  ...
  ['Plate_Pinch', 'carry', 'plate', 'forearms', '', 'weight-time', 'fam-plate-pinch', ['Plate Pinch Hold', 'Pinch Grip Hold']],
  ...
  ['Kneeling_High_Pulley_Row', 'horizontal-pull', 'cable', 'lats', 'rhomboids biceps', 'weight-reps', 'fam-row', ['Kneeling Rope Row', 'Kneeling Cable Pulldown']],
  ...
  ['One-Arm_Kettlebell_Clean', 'olympic', 'kettlebell', 'glute-max hamstrings', 'traps deltoids lower-back', 'weight-reps', 'fam-kettlebell-clean', ['Kettlebell Clean', 'Single-Arm Kettlebell Clean', 'KB Clean'], true],
  ['One-Arm_Kettlebell_Snatch', 'olympic', 'kettlebell', 'glute-max hamstrings deltoids', 'traps lower-back', 'weight-reps', 'fam-kettlebell-clean', ['Kettlebell Snatch', 'Single-Arm Kettlebell Snatch', 'KB Snatch'], true],
  ...
  ['Sled_Drag_-_Harness', 'carry', 'sled', 'quads glute-max', 'hamstrings calves', 'weight-time', 'fam-sled-push', ['Sled Pull', 'Harness Sled Drag', 'Backward Sled Drag']],
  ...
  ['Split_Jump', 'plyometric', 'bodyweight', 'quads glute-max', 'hamstrings calves', 'bodyweight-reps', 'fam-freehand-jump-squat', ['Jumping Lunge', 'Jump Lunge', 'Split Jumps']],
  ['Standing_Long_Jump', 'plyometric', 'bodyweight', 'quads glute-max', 'hamstrings calves', 'bodyweight-reps', 'fam-front-box-jump', ['Standing Broad Jump', 'Broad Jumps']],
  ...
  ['own-overhead-carry', 'carry', 'dumbbell kettlebell', 'deltoids abs', 'traps triceps', 'weight-time', 'fam-farmers-walk', ['Overhead Walk', 'Waiter Walk', 'Overhead Farmer Carry']],
...
export const DIFFICULTY_LISTS = {
  ...
  intermediate: [
    ...
    'Barbell_Step_Ups', 'Reverse_Grip_Bent-Over_Rows', 'Reverse_Hyperextension', 'Landmine_180s', 'Clean_and_Press',
    'Dumbbell_Clean', 'Knee_Tuck_Jump', 'Lateral_Bound', 'Split_Jump', 'Standing_Long_Jump', 'Plyo_Push-up',
