...
Updated 2026-09-24. **Shipped: req-01–09, req-11–23, req-25–31, req-33–108, req-110–111, req-109, req-112–113, req-115, req-114, req-120, req-118, req-116–117, req-119, req-121–130, req-133, req-139, req-138, req-140, req-143, req-145, req-147, req-148, req-151, req-150, req-142, req-141, req-24, req-152, req-153, req-154, req-155, req-156, req-157, req-158, req-159, req-160, req-161, req-162** (req-10 pending; req-32 dropped; req-77 PAUSED). **Gym-flow batch 4 LIVE 2026-09-23:** Emilio's feedback JSON
...
**READY, held:**
- **Follow-ups before any new feature (DEC-087), in order:** `req-163` comparison + History bugs [bug] → `req-165`
  cleanup: dead code, schema doc, lint, README [tooling] → `req-164` `storage.js` split [tooling] → `req-166` plan tooling.
  Then new features (req-144 creation design, req-10…). **Emilio:** a fresh Export + reimport **after req-163** (F-CODE-3).
