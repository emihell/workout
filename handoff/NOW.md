...
Updated 2026-09-24. **Shipped: req-01–09, req-11–23, req-25–31, req-33–108, req-110–111, req-109, req-112–113, req-115, req-114, req-120, req-118, req-116–117, req-119, req-121–130, req-133, req-139, req-138, req-140, req-143, req-145, req-147, req-148, req-151, req-150** (req-10 pending; req-24
...
**READY, held:**
- **Building:** `req-142` remove RepDB (READY; library up to par, req-151). **Then:** `req-141` fresh scan. **Waiting (Emilio, DEC-075):** req-146 backend (own server), req-144 creation design, req-149
