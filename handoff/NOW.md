...
Updated 2026-09-13. **Shipped: req-01–09, req-11–23, req-25–31, req-33–48, req-51–55** (req-10 pending;
...
**In flight:** `req-56` — Start/Edit buttons on routine rows; Schedule → 3rd Library segment
(Schedule·Routines·Exercises); drop the first-page Routines strip + orphaned `/start`. Touches route.js
→ reviewer before merge. **[ux-feel + functional]** (Emilio 2026-09-13, "execute directly".)
