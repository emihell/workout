...
**READY, held:**
- **Building:** `req-142` remove RepDB (library up to par, req-151). **Then:** `req-141` fresh scan. **Waiting (Emilio, DEC-075):** req-146 backend (own server), req-144 creation design, req-149
