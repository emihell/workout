...
Updated 2026-09-12. **Shipped: req-01–09, req-11–23, req-25–31, req-33–39** (req-10 pending; req-24
...
doctor content-check. Reqs specced one at a time. **req-36–39 shipped** (all trust bugs but progression); **building now: `req-40`** (progression unify — Emilio's hands, changes Finish save). L-007: store.jsx not unit-testable → logic in pure modules.
