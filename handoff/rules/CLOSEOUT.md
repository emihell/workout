...
The **planning session runs closeout**, on its own testing (**DEC-035**, and its two
carve-outs — see DEC-035). It records the req and runs the command. No freehand variants.
