...
**Status: BUILT AND MERGED, 2026-09-25 — branch `req-162` (`20e61e0`…`c161939`, 2 commits).** (2026-09-25) — **Lane: bug.** Found by req-159's smoke test on main (it logs it as a `note:`).
