...
**Status: BUILT AND MERGED, 2026-09-25 — branch `req-157` (`c9dc089`…`7d2f571`, 4 commits).** (2026-09-24) — Phase 1 bug, **persisted data** (reviewer + DEC-046 backup reminder before merge). DEC-085
