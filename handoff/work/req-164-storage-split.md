...
**Status: BUILT AND MERGED, 2026-09-25 — branch `req-164` (`42972d5`…`30cb172`, 6 commits).** (2026-09-25) — **Lane: tooling** (pure refactor, no behaviour change) — shared core → reviewer
