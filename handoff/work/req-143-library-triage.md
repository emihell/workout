...
**Status: BUILT AND MERGED, 2026-09-24 — branch `req-143` (`6acb9eb`…`8b79a4e`, 2 commits).** — Phase 1, data + one search rule. **Gate: functional** (library data, validators, tests, and the search
