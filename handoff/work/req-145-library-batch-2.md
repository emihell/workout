...
**Status: BUILT AND MERGED, 2026-09-24 — branch `req-145` (`906f4f3`…`7c5eaf1`, 2 commits).** — Phase 1, **data only**. **Gate: functional**. It's a follow-on batch under req-140's spec (DEC-066 §2),
