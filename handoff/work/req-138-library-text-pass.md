...
**Status: BUILT AND MERGED, 2026-09-24 — branch `req-138` (`b3c98af`…`7a50289`, 3 commits).** — Phase 1, **data only**. **Gate: functional** (library data + validators + tests; no reader, screen or
