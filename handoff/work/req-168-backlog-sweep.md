...
**Status: BUILT AND MERGED, 2026-09-25 — branch `req-168` (`b4adba8`…`376a01a`, 3 commits).** (2026-09-25) **Lane: bug** (mixed tooling + tests; the reviewer fires if storage/reducers are touched).
