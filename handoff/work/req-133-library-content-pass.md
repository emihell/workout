...
**Status: BUILT AND MERGED, 2026-09-24 — branch `req-133` (`e87d2a4`…`bbdb6f6`, 3 commits).** — Phase 1, **data only**. **Gate: functional** (library data + generator + tests; no stored-data
